...
def stepHandler(needLog) :
    ...
    state, vector, image = VectorBuilder.calcMove(circles, selfPosition, selfDirection, endPoint, True)
    ...
    if state == VectorBuilder.OK_STATE :

        # рисуем вектор скорсоти на карте
        draw = ImageDraw.Draw(image)
        VectorBuilder.drawSpeedVector(draw, vector[2:], selfPosition, selfDirection[2])
...
if __name__ == '__main__' :
    ...
    selfPosition = [random.randint(10, 450), random.randint(10, 210)]  # [50, 50]
